...
public class Keys {
    ...
    public static final UniqueKey<GoogleAuthenticationsRecord> GOOGLE_AUTHENTICATIONS_MAIL_ADDRESS_KEY = Internal.createUniqueKey(GoogleAuthentications.GOOGLE_AUTHENTICATIONS, DSL.name("google_authentications_mail_address_key"), new TableField[] { GoogleAuthentications.GOOGLE_AUTHENTICATIONS.MAIL_ADDRESS }, true);
    public static final UniqueKey<GoogleAuthenticationsRecord> GOOGLE_AUTHENTICATIONS_PKEY = Internal.createUniqueKey(GoogleAuthentications.GOOGLE_AUTHENTICATIONS, DSL.name("google_authentications_pkey"), new TableField[] { GoogleAuthentications.GOOGLE_AUTHENTICATIONS.USER_ID, GoogleAuthentications.GOOGLE_AUTHENTICATIONS.PRINCIPAL_ID }, true);
    public static final UniqueKey<GoogleAuthenticationsRecord> GOOGLE_AUTHENTICATIONS_PRINCIPAL_ID_KEY = Internal.createUniqueKey(GoogleAuthentications.GOOGLE_AUTHENTICATIONS, DSL.name("google_authentications_principal_id_key"), new TableField[] { GoogleAuthentications.GOOGLE_AUTHENTICATIONS.PRINCIPAL_ID }, true);
    ...
    public static final ForeignKey<GoogleAuthenticationsRecord, UsersRecord> GOOGLE_AUTHENTICATIONS__GOOGLE_AUTHENTICATIONS_USER_ID_FKEY = Internal.createForeignKey(GoogleAuthentications.GOOGLE_AUTHENTICATIONS, DSL.name("google_authentications_user_id_fkey"), new TableField[] { GoogleAuthentications.GOOGLE_AUTHENTICATIONS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
    ...
    public static final ForeignKey<UserGroupsRecord, UsersRecord> USER_GROUPS__USER_GROUPS_USER_ID_FKEY = Internal.createForeignKey(UserGroups.USER_GROUPS, DSL.name("user_groups_user_id_fkey"), new TableField[] { UserGroups.USER_GROUPS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
}
