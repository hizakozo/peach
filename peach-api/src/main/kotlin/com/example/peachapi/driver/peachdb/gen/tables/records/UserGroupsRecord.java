...
public class UserGroupsRecord extends UpdatableRecordImpl<UserGroupsRecord> implements Record2<UUID, UUID> {
    ...
    @Override
    public UserGroupsRecord value2(UUID value) {
        setUserId(value);
        return this;
    }

    @Override
    public UserGroupsRecord values(UUID value1, UUID value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public UserGroupsRecord(UUID groupId, UUID userId) {
        super(UserGroups.USER_GROUPS);
