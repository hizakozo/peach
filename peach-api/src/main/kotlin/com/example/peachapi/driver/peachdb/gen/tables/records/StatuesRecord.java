...
public class StatuesRecord extends UpdatableRecordImpl<StatuesRecord> implements Record10<UUID, UUID, String, String, LocalDateTime, UUID, LocalDateTime, UUID, UUID, LocalDateTime> {
    ...
    @Override
    public StatuesRecord value6(UUID value) {
        setCreatedBy(value);
        return this;
    }
    ...
    @Override
    public StatuesRecord value8(UUID value) {
        setChangedBy(value);
        return this;
    }

    @Override
    public StatuesRecord value9(UUID value) {
        setDeletedBy(value);
        return this;
    }
    ...
    @Override
    public StatuesRecord values(UUID value1, UUID value2, String value3, String value4, LocalDateTime value5, UUID value6, LocalDateTime value7, UUID value8, UUID value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public StatuesRecord(UUID statusId, UUID categoryId, String statusName, String statusColor, LocalDateTime createdAt, UUID createdBy, LocalDateTime changedAt, UUID changedBy, UUID deletedBy, LocalDateTime deletedAt) {
        super(Statues.STATUES);
